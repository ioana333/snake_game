...
public class Main extends Application {
    ...
    private static final String[] FOODS_IMAGE = new String[]{
            "/img/coliva.png", "/img/cozonac.png", "/img/dubai.png", "/img/castraveti.png", "/img/ciorba.png", "/img/kurtos.png",
            "/img/mamaliga.png", "/img/mici.png", "/img/papanasi.png", "/img/lanogs.png", "/img/mici2.png", "/img/pizza.png",
            "/img/salata.png", "/img/sarmale.png", "/img/tuica.png", "/img/pulpa.png", "/img/sarmale2.png",
            "/img/visinata.png", "/img/zacusca.png"
    };
...
//            {
//                playSound("D://Ioana//FACULTATE//POO//snake_game//snake_game//snake//src//sound//HATZ.wav");
//            }
